                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/<?php if(empty($user['photo'])) echo 'avatar_01.png'; else echo $user['photo'];?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="page_profile.php?id=<?=$user['id']?>" class="fs-xl text-truncate text-truncate-lg text-info"><?=$user['name']?></a>
                                    <?php
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="user_delete.php?id=<?=$user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
